...
-- Acá va directo el script principal en vez de cargarlo de afuera
-- Esto es para evitar los errores 404 y de carga
    ...
    spawn(function()
        while autoSell do
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                firetouchinterest(player.Character.HumanoidRootPart, game:GetService("Workspace").sellAreaCircles.sellAreaCircle.circleInner, 0)
                wait(0.1)
                firetouchinterest(player.Character.HumanoidRootPart, game:GetService("Workspace").sellAreaCircles.sellAreaCircle.circleInner, 1)
                wait(5)
            else
                wait(1)
            end
...
print("KRONOS SCRIPT v1.3 - Carga completa. ¡A romper todo!")
